export default {
    ...
    optsMinDays: 'Минимальное количество дней, которые можно выбрать за один раз (например, при выборе диапазона дат).',
    optsMaxDays: 'Максимальное количество дней, которые можно выбрать за один раз (например, при выборе диапазона дат).',
    optsQueueMode: 'Включает режим очереди при выборе дат. При превышении допустимого количества выбранных дат самые ранние даты удаляются автоматически.',
    optsIncludeTemporaryInSelected: 'Определяет, считаются ли даты выбранными до выполнения ограничений minDays и maxDays.',
    optsAllowExtendRange: 'Разрешает автоматически расширять диапазон дат при клике за его пределами с учётом minDays и maxDays.',
    optsNonStrictRanges: 'Определяет поведение диапазона при наличии заблокированных дат внутри него.',
