export default {
    ...
    optsMinDays: 'Минимальное количество дней, которые можно выбрать за один раз (при выборе диапазона дат).',
    optsMaxDays: 'Максимальное количество дней, которые можно выбрать за один раз (при выборе диапазона дат).',
