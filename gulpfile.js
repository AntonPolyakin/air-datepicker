...
gulp.task('pug-ru', pug.ru);
gulp.task('pug-en', pug.en);
gulp.task('gzip', gzip);
...
gulp.task('watch', function() {
  ...
  gulp.watch('docs/pug/**/*.pug', gulp.series('pug-ru', 'pug-en')).on('change', livereload.changed);
});

gulp.task('dev', gulp.series('css', 'js', 'i18n', 'cssPage', 'pug-ru', 'pug-en', 'watch'));
gulp.task('build', gulp.series('css', 'js', 'i18n', 'pug-ru', 'pug-en'));
